...
func registerChannelRoutes(apiRouter *gin.RouterGroup) {
	...
	channelRoute.GET("/supplier-routing/realtime", middleware.RequirePermission(authz.ChannelRead), controller.GetSupplierRealtime)
...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/discovery", permission: authz.ChannelRead, handler: controller.GetChannelDiscovery},
	{method: http.MethodGet, path: "/probe_balance/:id", permission: authz.ChannelRead, handler: controller.ProbeChannelBalance},
