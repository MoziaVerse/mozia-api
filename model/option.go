...
func InitOptionMap() {
	...
	common.OptionMap["PublicVideoAddress"] = system_setting.PublicVideoAddress
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "PublicVideoAddress":
		system_setting.PublicVideoAddress = value
	case "WorkerUrl":
	...
	case "GroupTaskLimits":
		err = setting.UpdateGroupTaskLimitsByJSONString(value)
	case "TaskLimitScope":
		err = setting.UpdateTaskLimitScopeByJSONString(value)
	case "RetryTimes":
